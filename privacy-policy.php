		...
		<div class="row justify-content-center">
			<div class="col-lg-7">
				<div class="bread-titlev2">
					<h1 class="wow fadeInUp" data-wow-delay=".2s">Privacy Policy</h1>
		...
		<div class="row">
			...
			<div class="col-lg-12 block-1">
				<div class="common-heading text-l pl25">
					...
					<p>Websodesign Web Solution strives to provide maximum advantage to customers worldwide with their affordable, yet high-quality website design services in USA. We give your target audience the best experience with a powerful website design that helps your business stay ahead of the competition. </p>
					<p>We ensure that all the requirements of our customers are met without any hurdle or hassle. Our website designers exceed clients’ expectations with a cutting-edge approach for the websites to stand out. Need a flawlessly designed website? Contact Websodesign Web Solution today and experience the change.</p>
...
<p>
Websodesign Web Solution.com uses a secure server for the purpose of securing your private information. All your private/credit information sends out via Secure Socket Layer (SSL) technology that is used to keep the information confidential when you place your order online.
</p>

<h2> What do we use your information for? </h2>

<p>
We use the personal data for handling orders. Websodesign Web Solution and its members use your personal data and other personally non-identifiable information that will help us in handling your orders properly and to better respond to your complexity. Furthermore, your information may be used for the following ways:
