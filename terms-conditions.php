		...
		<div class="row justify-content-center">
			<div class="col-lg-7">
				<div class="bread-titlev2">
					<h1 class="wow fadeInUp" data-wow-delay=".2s">Terms and Conditions</h1>
...
<br><br>
(f) Client Accounts. When you register for the Service, you must pay for the Service via credit card, or other payment method authorized by Websodesign Web Solution. You will be charged for the Package you have selected along with and additional products and/or services you select as add-ons. If you pay by credit card, you will be required to provide a valid credit card number and credit card billing address when registering as a Client. Websodesign Web Solution will email you a receipt for the transactions in which you are involved. Our fee policy for Clients may change and we may decide to impose additional fees on Clients at any time; however, such additional fees will not apply to projects submitted before Websodesign Web Solution implements any such change in fees.



</p>
<h2> Registration, Password, User Identity
 </h2> 
...
(b) Access Numbers, Passwords, and Password Access. You shall keep confidential, shall not disseminate, and shall use solely in accordance with these Terms and Conditions, your User Identity, registration identification and password for the Web Site. You shall immediately notify Websodesign Web Solution if you learn of or suspect: (i) any loss or theft of your User Identity, registration identification or password, or (ii) any unauthorized use of your registration identification or password or of the Web Site. In the event of such loss, theft, or unauthorized use, Websodesign Web Solution may impose on you, at Websodesign Web Solution ' sole discretion, additional security obligations.
<br><br>
(c) Security Breaches and Revision. If any unauthorized person obtains access to the Web Site as a result of any act or omission by you, you shall use your best efforts to ascertain the source and manner of acquisition and shall fully and promptly inform Websodesign Web Solution You shall otherwise cooperate and assist in any investigation relating to any such unauthorized access.

</p>



<h2> Ownership; Rights to Us  </h2>

<p>
(a) Creative and Response Briefs. Upon submission of a Creative or Response Brief or any other information or media provided by you in connection with your use of the Service (collectively, the "Client Information"), Websodesign Web Solution and its agents shall have all rights and licenses necessary to use such Client Information for the purpose of obtaining Responses and for archival purposes. Each Member to whom your project is made available has the right to review and display the relevant Term Sheet for purposes of preparing a Response.
<br><br>
(b) Rights of Websodesign Web Solution. Upon your submission of Client Information to the Service, you grant Websodesign Web Solution a royalty-free, perpetual, irrevocable, sub-licensable , exclusive, worldwide right (including any moral rights) and license to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, communicate to the public, perform and display (in whole or in part), and/or incorporate in other works, in any form, media, or technology now known or later developed, such Client Information, for the full term of any intellectual property rights that may exist in such Client Information to the extent necessary to provide you with the Service and Responses.
<br><br>
(c) Rights of Clients. Subject to your compliance with these Terms and Conditions, you shall own the final the Response composition provided to you by Websodesign Web Solution. (the "Final Product"). You shall not, however, own any materials, media or other content generated during any revision cycles leading up to the Final Product, and Websodesign Web Solution expressly reserves all right, title and interest in and to the same. You acknowledge and hereby grant to Websodesign Web Solution a royalty-free, irrevocable exclusive worldwide right to use Creative and Revision Briefs, individual Responses provided to you, and Final Product for internal and archival purposes, and in order to display and promote the Websodesign Web Solution Service. Websodesign Web Solution retains the rights to all artwork concepts and other content not selected by you.


</p>

<h2> Nondisclosure and Privacy
 </h2>

<p>
Websodesign Web Solution. intends to use commercially reasonable efforts to follow its privacy policy; as such privacy policy may be changed from time to time at Websodesign Web Solution ' sole discretion. Notwithstanding the foregoing, Websodesign Web Solution cannot and does not assume any responsibility or liability for any information submitted to the Web Site or for the use or misuse of any information submitted by you or any other person, including, without limitation, any information accessed by a hacker or by any other malici
...
<p>
(a) Eligibility Requirements. To register as a Client, you must be at least 18 years of age, agree to these Terms and Conditions and Websodesign Web Solution privacy policy, and complete the registration procedure. By registering as a Client, you represent and warrant that you meet these eligibility requirements, that the information you include as part of the registration process is complete and accurate and, if you are registering on behalf of an entity, that you are authorized to bind that entity to these Terms and Conditions. Websodesign Web Solution may accept or reject your registration in its sole discretion.
...
(i) reveals trade secrets, unless you own them;<br>
(ii) infringes on any other proprietary or intellectual property rights of others, on the privacy or publicity rights of others, or any statutory right;<br>
(iii) is obscene, defamatory, threatening, harassing, abusive, hateful, or embarrassing to any other person or entity;<br>
(iv) is sexually- explicit;<br>
(v) constitutes advertisements or solicitations of business, chain letters or pyramid schemes; or<br>
(vi) contains viruses, Trojan horses, worms, time bombs, or other computer programming routines or engines that are intended to damage, detrimentally interfere with, surreptitiously intercept or expropriate any system, data or information. You further agree not to<br>
(a) use any incomplete, false or inaccurate biographical information or other information for purposes of registering as a Client;<br>
(b) delete or revise any material or other information of any other user of Websodesign Web Solution ;<br>
(c) take any action that imposes an unreasonable or disproportionately large load on the Web Site's infrastructure;<br>
(d) use any device, software or routine to interfere or attempt to interfere with the proper working of the Service or any activity being conducted on the Web Site;<br>
(e) use or attempt to use any engine, software, tool, agent or other device or mechanism (including, without limitation, browsers, spiders, robots, avatars or intelligent agents) to navigate or search the Web Site, other than the search engine and search agents available from Websodesign Web Solution on the Web Site and other than generally available third-party web browsers (e.g., Microsoft Internet Explorer and Netscape Navigator); or<br>
...
<p>
By using the Websodesign Web Solution Service, you agree to receive, via email or otherwise, status notifications, a monthly newsletter, and carefully selected special offers and promotions for certain products and services that we believe could be of value to our Clients. This is essential to maintaining the low-cost of our services. You are free to unsubscribe from any newsletters we send to you at any time. Websodesign Web Solution may or may not use a third party to send email or otherwise contact you, however, your personal identifying information will never be disclosed or shared with another party in a manner inconsistent with Websodesign Web Solution ' privacy policy.
...
<h2> Disclaimers; Indemnification; Limitations of Liability
 </h2>
<p>
(a) Responsibility for Content. Websodesign Web Solution shall not be responsible for any use that is or is not made of the Web Site or the Service. Without limiting the foregoing, Websodesign Web Solution makes no representations, warranties or covenants regarding, and does not guarantee, the truthfulness, accuracy, or reliability of any information or other material (including, without limitation, any Creative Brief, Term Sheets, Responses or User Identity) that are communicated through, or posted to, the Service, whether by Members, Clients, Websodesign Web Solution or otherwise, nor does Websodesign Web Solution endorse any opinions expressed by any user of the Web Site, including any Member or Client. Without limiting the foregoing, Websodesign Web Solution makes no representations, warranties or covenants regarding the validity of the rights to Responses granted pursuant to these Terms and Conditions. You acknowledge that any reliance on information or other material, including, without limitation, any information related to a particular Package or your project, Term Sheet, Response or User Identity, communicated through the Service, or posted to the Web Site, will be at your own risk. Without limiting the foregoing, you agree and acknowledge that you use each Response at your own risk and that you are responsible for taking any actions you deem reasonable to determine whether your use of a Response will infringe any statutory or third-party intellectual property, privacy or publicity rights. Photos / Images: Websodesign Web Solution shall not be responsible for any use of photos that are not royalty free. It is the clients' responsibility to purchase and pay for all rights to use any photos, images, graphics, icons, logos, and/or designs for any designs created by Websodesign Web Solution for the client. This includes websites, website templates, brochures, business cards, postcards, stationery, signage, animations, commercials, slogans, flyers, banners, stickers, promotional items, and/or desktop wallpapers.

<br><br>


Websodesign Web Solution offers a 100% refund in case of non-delivery of agreed service. The customer will NOT be eligible for a refund under the following circumstances:
<br><br>
If the order has been in production for >30 days and deliveries have been made to the client.<br>
If the customer has asked for a second revision.<br>
If the customer has a change of mind i.e., they do not want the purchased service due to any reason.<br>
If the customer does not provide a feedback on a delivered project (or part of the project) within 7 days.
